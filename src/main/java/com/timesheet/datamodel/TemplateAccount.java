...
public class TemplateAccount implements Serializable {
	...
	private TemplateAccount children;

	@ManyToOne(optional = true)
	private Codelookup typeCompany;

    @NotNull
    @Enumerated(EnumType.STRING)
    @Column(name = "ACC_TYPE", nullable = false)
    private AccType accType;
	// TODO need to chgange it to enum
	@NotNull
	@Enumerated(EnumType.STRING) // its should be mentioned whenn the datatype is ENUM not when its String
...
//    private   List<Integer> groupTypelist = new ArrayList<Integer>();
	...
	public TemplateAccount getChildren() {
		return children;
	}

	public void setChildren(TemplateAccount children) {
		this.children = children;
	}

	public Codelookup getTypeCompany() {
		return typeCompany;
	}

	public void setTypeCompany(Codelookup typeCompany) {
