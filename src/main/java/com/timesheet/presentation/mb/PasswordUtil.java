...
public class PasswordUtil {
	...
	public static String qrUrl(User user , String secret ) {
		StringBuilder sb = new StringBuilder(128);
		addOtpAuthPart2(user, secret, sb);
		return sb.toString();
	}
	/**
	...
	private static void addOtpAuthPart2( User issuer ,String secret, StringBuilder sb) {
		sb.append("otpauth://totp/").append(issuer.getUserName()).append(":").append(issuer.getEmail().trim()).append("?secret=").append(secret).append("&issuer=").append(issuer.getUserName());
	}
